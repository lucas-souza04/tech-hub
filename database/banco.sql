...
( 
 ...
 id_aluno INT NOT NULL,  
    FOREIGN KEY (id_aluno) REFERENCES tb_aluno(id_aluno) ON DELETE CASCADE ON UPDATE CASCADE
);  
...
( 
 ...
 id_cadastro INT NOT NULL,  
    FOREIGN KEY (id_cadastro) REFERENCES tb_cadastro(id_cadastro) ON DELETE CASCADE ON UPDATE CASCADE,
 id_curso INT NOT NULL,  
    FOREIGN KEY (id_curso) REFERENCES tb_curso(id_curso) ON DELETE CASCADE ON UPDATE CASCADE
);
